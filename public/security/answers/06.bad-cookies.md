...
This means the browser is given a session cookie like "nzp10bfod16smd6umq1dd6le34", and this acts like a key to unlock a file that's stored on your server. It can store anything you like about the user, and those values cannot be seen or edited by the user.
...
- There was a Cross Site Scripting (XSS) vulnerability, the victim loaded the page, and the JavaScript sent their cookies to the evil hackers website (where they copied the session ID into their own browser).
